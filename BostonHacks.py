...
if "no" in intollerances:
    url = "https://api.spoonacular.com/recipes/complexSearch?query={}&intoleraces={}&apiKey=8ab612a2b9c34e8e9133b74ad4806b14".format(food,intollerances)
else:
...
output = {'name': generatedfoods["results"][Food]["title"], 'ingredients' : ing_list, 'instructions' : recipe_dict["instructions"] }
